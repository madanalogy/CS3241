...
const char cubeTexFile[] = "images/dice.jpg";
...
// This texture object is for the cube texture map.
...
/////////////////////////////////////////////////////////////////////////////
// TODO: Draw a texture-mapped Cube.
/////////////////////////////////////////////////////////////////////////////

void DrawCube(void )
{
    float size = 1.0;
    float CUBE_WIDTH = size * 0.3;
    ...
    glPushMatrix();
    glTranslated( 0.6 * size, -0.5 * size, size * 0.4 + TABLETOP_Z );

    // In +y direction, two
    glNormal3f( 0.0, 1.0, 0.0 ); // Normal vector.
    SubdivideAndDrawQuad( 24, 24, 0.5, 0.25, CUBE_HALF_WIDTH, CUBE_HALF_WIDTH, 0,
            0.75, 0.25, CUBE_HALF_WIDTH, CUBE_HALF_WIDTH, CUBE_WIDTH,
            0.75, 0.5, -CUBE_HALF_WIDTH, CUBE_HALF_WIDTH, CUBE_WIDTH,
            0.5, 0.5, -CUBE_HALF_WIDTH, CUBE_HALF_WIDTH, 0);
    // In -y direction, five
    glNormal3f( 0.0, -1.0, 0.0 ); // Normal vector.
    SubdivideAndDrawQuad( 24, 24, 0.25, 0.25, CUBE_HALF_WIDTH, -CUBE_HALF_WIDTH, 0,
            0.25, 0.5, -CUBE_HALF_WIDTH, -CUBE_HALF_WIDTH, 0,
            0, 0.5, -CUBE_HALF_WIDTH, -CUBE_HALF_WIDTH, CUBE_WIDTH,
            0, 0.25, CUBE_HALF_WIDTH, -CUBE_HALF_WIDTH, CUBE_WIDTH);
    // In +x direction, one
    glNormal3f( 1.0, 0.0, 0.0 ); // Normal vector.
    SubdivideAndDrawQuad( 24, 24, 0.5, 0.25, CUBE_HALF_WIDTH, CUBE_HALF_WIDTH, 0,
            0.25, 0.25, CUBE_HALF_WIDTH, -CUBE_HALF_WIDTH, 0,
            0.25, 0.0, CUBE_HALF_WIDTH, -CUBE_HALF_WIDTH, CUBE_WIDTH,
            0.5, 0.0, CUBE_HALF_WIDTH, CUBE_HALF_WIDTH, CUBE_WIDTH);
    // In -x direction, six
    glNormal3f( -1.0, 0.0, 0.0 ); // Normal vector.
    SubdivideAndDrawQuad( 24, 24, 0.5, 0.5, -CUBE_HALF_WIDTH, CUBE_HALF_WIDTH, 0,
            0.5, 0.75, -CUBE_HALF_WIDTH, CUBE_HALF_WIDTH, CUBE_WIDTH,
            0.25, 0.75, -CUBE_HALF_WIDTH, -CUBE_HALF_WIDTH, CUBE_WIDTH,
            0.25, 0.5, -CUBE_HALF_WIDTH, -CUBE_HALF_WIDTH, 0);
    // In +z direction, three
    glNormal3f( 0.0, 0.0, 1.0 ); // Normal vector.
    SubdivideAndDrawQuad( 24, 24, 0.75, 0.25, CUBE_HALF_WIDTH, CUBE_HALF_WIDTH, CUBE_WIDTH,
            1.0, 0.25, -CUBE_HALF_WIDTH, CUBE_HALF_WIDTH, CUBE_WIDTH,
            1.0, 0.5, -CUBE_HALF_WIDTH, -CUBE_HALF_WIDTH, CUBE_WIDTH,
            0.75, 0.5, CUBE_HALF_WIDTH, -CUBE_HALF_WIDTH, CUBE_WIDTH);
    // In -z direction, four
    glNormal3f( 0.0, 0.0, -1.0 ); // Normal vector.
    SubdivideAndDrawQuad( 24, 24, 0.5, 0.25, CUBE_HALF_WIDTH, CUBE_HALF_WIDTH, 0,
...
// Tabletop.
    ...
    // so that the reflection texture map is correctly mapped on it.
    //
    ...
    //****************************
    // TODO: Map Texture to Tabletop
    //****************************

    glTexEnvf(GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE, GL_MODULATE);
    glBindTexture(GL_TEXTURE_2D, reflectionTexObj);
    glNormal3f(0, 0, 1);
    SubdivideAndDrawQuad(24, 24, 0, 0, TABLETOP_X1, TABLETOP_Y1, TABLETOP_Z,
            0, 1.0, TABLETOP_X2, TABLETOP_Y1, TABLETOP_Z, 1.0, 1.0,
            TABLETOP_X2, TABLETOP_Y2, TABLETOP_Z, 1.0, 0, TABLETOP_X1, TABLETOP_Y2, TABLETOP_Z);
